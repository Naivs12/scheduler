    ...
    <AuthenticatedLayout>
        <div class="flex justify-center items-center h-screen w-full">
            <div class="bg-white p-4 w-[500px] h-auto flex flex-col rounded-sm mt-[-15vw]">
                ...
                <div class="w-full my-1">
                    <label>Room:</label><br>
                    <input type="text" v-model="form.name" class="w-full rounded-md"></input>
                </div>
    ...
    methods: {
        submitSchedule() {
            ...
            if(this.schedule == null) {
                this.$inertia.post('/maintenance/room-schedule/store', this.form);
            } else {
                this.$inertia.post('/maintenance/room-schedule/update', this.form);
            }
